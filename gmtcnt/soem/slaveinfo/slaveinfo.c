...
char* dtype2string(uint16 dtype)
{
    ...
    {
        case ECT_BOOLEAN:
            snprintf(hstr, sizeof(hstr), "BOOLEAN");
            break;
        case ECT_INTEGER8:
            snprintf(hstr, sizeof(hstr), "INTEGER8");
            break;
        case ECT_INTEGER16:
            snprintf(hstr, sizeof(hstr), "INTEGER16");
            break;
        case ECT_INTEGER32:
            snprintf(hstr, sizeof(hstr), "INTEGER32");
            break;
        case ECT_INTEGER24:
            snprintf(hstr, sizeof(hstr), "INTEGER24");
            break;
        case ECT_INTEGER64:
            snprintf(hstr, sizeof(hstr), "INTEGER64");
            break;
        case ECT_UNSIGNED8:
            snprintf(hstr, sizeof(hstr), "UNSIGNED8");
            break;
        case ECT_UNSIGNED16:
            snprintf(hstr, sizeof(hstr), "UNSIGNED16");
            break;
        case ECT_UNSIGNED32:
            snprintf(hstr, sizeof(hstr), "UNSIGNED32");
            break;
        case ECT_UNSIGNED24:
            snprintf(hstr, sizeof(hstr), "UNSIGNED24");
            break;
        case ECT_UNSIGNED64:
            snprintf(hstr, sizeof(hstr), "UNSIGNED64");
            break;
        case ECT_REAL32:
            snprintf(hstr, sizeof(hstr), "REAL32");
            break;
        case ECT_REAL64:
            snprintf(hstr, sizeof(hstr), "REAL64");
            break;
        case ECT_BIT1:
            snprintf(hstr, sizeof(hstr), "BIT1");
            break;
        case ECT_BIT2:
            snprintf(hstr, sizeof(hstr), "BIT2");
            break;
        case ECT_BIT3:
            snprintf(hstr, sizeof(hstr), "BIT3");
            break;
        case ECT_BIT4:
            snprintf(hstr, sizeof(hstr), "BIT4");
            break;
        case ECT_BIT5:
            snprintf(hstr, sizeof(hstr), "BIT5");
            break;
        case ECT_BIT6:
            snprintf(hstr, sizeof(hstr), "BIT6");
            break;
        case ECT_BIT7:
            snprintf(hstr, sizeof(hstr), "BIT7");
            break;
        case ECT_BIT8:
            snprintf(hstr, sizeof(hstr), "BIT8");
            break;
        case ECT_VISIBLE_STRING:
            snprintf(hstr, sizeof(hstr), "VISIBLE_STRING");
            break;
        case ECT_OCTET_STRING:
            snprintf(hstr, sizeof(hstr), "OCTET_STRING");
            break;
        default:
            snprintf(hstr, sizeof(hstr), "Type 0x%4.4X", dtype);
    }
    return hstr;
}
...
char* SDO2string(uint16 slave, uint16 index, uint8 subidx, uint16 dtype)
{
   ...
   else
   {
      switch(dtype)
      {
         case ECT_BOOLEAN:
            u8 = (uint8*) &usdo[0];
            if (*u8) snprintf(hstr, sizeof(hstr), "TRUE");
             else snprintf(hstr, sizeof(hstr), "FALSE");
            break;
         case ECT_INTEGER8:
            i8 = (int8*) &usdo[0];
            snprintf(hstr, sizeof(hstr), "0x%2.2x %d", *i8, *i8);
            break;
         case ECT_INTEGER16:
            i16 = (int16*) &usdo[0];
            snprintf(hstr, sizeof(hstr), "0x%4.4x %d", *i16, *i16);
            break;
         case ECT_INTEGER32:
         case ECT_INTEGER24:
            i32 = (int32*) &usdo[0];
            snprintf(hstr, sizeof(hstr), "0x%8.8x %d", (unsigned int)*i32, (int)*i32);
            break;
         case ECT_INTEGER64:
            i64 = (int64*) &usdo[0];
            snprintf(hstr, sizeof(hstr), "0x%16.16"PRIx64" %"PRId64, *i64, *i64);
            break;
         case ECT_UNSIGNED8:
            u8 = (uint8*) &usdo[0];
            snprintf(hstr, sizeof(hstr), "0x%2.2x %u", *u8, *u8);
            break;
         case ECT_UNSIGNED16:
            u16 = (uint16*) &usdo[0];
            snprintf(hstr, sizeof(hstr), "0x%4.4x %u", *u16, *u16);
            break;
         case ECT_UNSIGNED32:
         case ECT_UNSIGNED24:
            u32 = (uint32*) &usdo[0];
            snprintf(hstr, sizeof(hstr), "0x%8.8x %u", (unsigned int)*u32, (int)*u32);
            break;
         case ECT_UNSIGNED64:
            u64 = (uint64*) &usdo[0];
            snprintf(hstr, sizeof(hstr), "0x%16.16"PRIx64" %"PRIu64, *u64, *u64);
            break;
         case ECT_REAL32:
            sr = (float*) &usdo[0];
            snprintf(hstr, sizeof(hstr), "%f", *sr);
            break;
         case ECT_REAL64:
            dr = (double*) &usdo[0];
            snprintf(hstr, sizeof(hstr), "%f", *dr);
            break;
         case ECT_BIT1:
         case ECT_BIT2:
         case ECT_BIT3:
         ...
         case ECT_BIT8:
            u8 = (uint8*) &usdo[0];
            snprintf(hstr, sizeof(hstr), "0x%x", *u8);
            break;
         case ECT_VISIBLE_STRING:
            strcpy(hstr, usdo);
            break;
         case ECT_OCTET_STRING:
            ...
            break;
         default:
            snprintf(hstr, sizeof(hstr), "Unknown type");
      }
      return hstr;
   }
}
            ...
            for(nSM = 0 ; nSM < EC_MAXSM ; nSM++)
            {
               if(ec_slave[cnt].SM[nSM].StartAddr > 0)
                  printf(" SM%1d A:%4.4x L:%4d F:%8.8x Type:%d\n",nSM, etohs(ec_slave[cnt].SM[nSM].StartAddr), etohs(ec_slave[cnt].SM[nSM].SMlength),
                         (unsigned int)etohl(ec_slave[cnt].SM[nSM].SMflags), ec_slave[cnt].SMtype[nSM]);
            }
            for(j = 0 ; j < ec_slave[cnt].FMMUunused ; j++)
            {
               printf(" FMMU%1d Ls:%8.8x Ll:%4d Lsb:%d Leb:%d Ps:%4.4x Psb:%d Ty:%2.2x Act:%2.2x\n", j,
                       (unsigned int)etohl(ec_slave[cnt].FMMU[j].LogStart), etohs(ec_slave[cnt].FMMU[j].LogLength), ec_slave[cnt].FMMU[j].LogStartbit,
...
int main(int argc, char *argv[])
{
   ...
   if (argc > 1)
   {
      ...
      if ((argc > 2) && (strncmp(argv[2], "-map", sizeof("-map")) == 0)) printMAP = TRUE;
			...
			strlcpy(ifbuf, argv[1], sizeof(ifbuf));
      slaveinfo(ifbuf);
   }
   else
   {
